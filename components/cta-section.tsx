          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-slide-in-left">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <select className="w-full h-14 bg-white/10 border border-white/20 text-white rounded-lg px-4 backdrop-blur-sm focus:border-white focus:bg-white/20 focus:outline-none">
                    ...
                    <option value="babysitting" className="text-gray-900">
                      Babysitting
                    </option>
