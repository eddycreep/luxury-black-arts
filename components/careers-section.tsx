      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Content - Form Section with CTA-style background and slide-in animation */}
            <div
              ref={rightContentRef}
              className={`relative animate-on-scroll animate-slide-in-right ${rightInView ? "in-view" : ""}`}
            >
              {/* CTA-style background container */}
              <div className="bg-gradient-to-br from-green-400 via-green-500 to-green-600 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
                {/* Background decoration elements matching CTA section */}
                <div className="absolute inset-0 bg-gradient-to-r from-green-400/90 to-green-500/90"></div>
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-green-300/20 to-transparent"></div>

                {/* Decorative background patterns */}
                <div className="absolute inset-0 opacity-10">
                  <div className="absolute top-10 right-10 w-20 h-20 bg-white rounded-full blur-lg"></div>
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-bold text-white leading-tight">
                      Join Our <span className="text-green-100">Team</span>
                    </h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Input
                          ...
                          className="h-14 bg-white/15 border border-white/30 text-white placeholder:text-green-100 focus:border-white/60 focus:bg-white/25 rounded-xl backdrop-blur-md shadow-lg transition-all duration-300"
                          required
                    ...
                    <div className="space-y-2">
                      <textarea
                        ...
                        rows={4}
                        className="w-full bg-white/15 border border-white/30 text-white placeholder:text-green-100 focus:border-white/60 focus:bg-white/25 rounded-xl px-4 py-3 resize-none backdrop-blur-md shadow-lg focus:outline-none transition-all duration-300"
                      />
                    </div>
                    ...
                    <Button
                      ...
                      type="submit"
                      size="lg"
                      className="w-full h-14 bg-white/20 backdrop-blur-md border border-white/30 text-white hover:bg-white hover:text-green-700 text-lg font-semibold rounded-xl group shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                    >
                      Submit Application
                  ...
                  <div className="flex items-center space-x-6 pt-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-green-50 text-sm">Quick Response</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Users className="w-5 h-5 text-green-100" />
                      <span className="text-green-50 text-sm">Growing Team</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Heart className="w-5 h-5 text-green-100" />
                      <span className="text-green-50 text-sm">Make a Difference</span>
                    </div>
                  </div>
                </div>
              </div>
